<form class="f-register pl-3" method="post">
    <div class="col">
        <h1 class="text-title pt-2">Editar material <?php echo "X"; ?></h1>
        <hr class="pb-4">
    </div>
    <div class="form-group ml-3">
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="Equipamento" id="Equipamento" value="Equipamento">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <input type="number" class="form-control" value="1" name="quantidade" id="Estoque">
            </div>
