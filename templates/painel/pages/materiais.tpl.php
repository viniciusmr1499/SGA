<div id="form-register">
    <section class="row">
        ...
        <div  class="ml-auto mr-3">
            ...
            <a href="/painel/pages/novo-material" class="text-title mt-1 btn btn-info"><i class="fas fa-plus"> Adicionar Material </i></a>
        </div>
            ...
            <div class="modal-body">
                <form method="POST"action="/painel/pages/renovar-estoque">
                    <div class="row">
                        ...
                        <div class="position">
                            <button type="button" id="buscarNomeEquipamento2" class="btn btn-info">
